...
function UserSettings() {
  return (
    <div className="rounded-xl border border-border bg-card p-6 shadow-card">
      <h2 className="mb-4 font-display text-lg font-bold text-foreground">Usuários e Permissões</h2>
      <div className="space-y-3">
        <div className="flex items-center gap-3 rounded-lg bg-muted/50 p-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Acesso total: configurações, vagas, candidatos, relatórios</p>
          </div>
        </div>
        <div className="flex items-center gap-3 rounded-lg bg-muted/50 p-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-accent text-xs font-bold text-accent-foreground">R</div>
          <div>
            <p className="text-sm font-semibold text-foreground">Recrutador</p>
            <p className="text-xs text-muted-foreground">Gestão de vagas e candidatos, sem acesso a configurações globais</p>
          </div>
        </div>
        <div className="flex items-center gap-3 rounded-lg bg-muted/50 p-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-muted text-xs font-bold text-muted-foreground">L</div>
          <div>
            <p className="text-sm font-semibold text-foreground">Leitor</p>
            <p className="text-xs text-muted-foreground">Apenas visualização de vagas e candidatos</p>
          </div>
        </div>
      </div>
    </div>
